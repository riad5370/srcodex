        ...
        <div class="row v-center">
            <div class="col-lg-6 tablet-lg-top-45">
                <div class="promo-box bg-glass p-40" data-aos="fade-up">
                    ...
                    @endif --}}
                    <form class="needs-validation" id="contact-form" method="POST" novalidate="novalidate">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-name" name="user_name"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact-project"
                                    name="user_project" placeholder="&#xf059; Subject"
                                        style="font-family:'Font Awesome 5 Free', sans-serif !important; font-weight: 400">
                                </div><!--  SRCodeX LTD Codes form-group -->
                            </div><!--  SRCodeX LTD Codes column -->
                        </div><!--  SRCodeX LTD Codes row -->
                        <div class="form-group">
                            <textarea id="contact-message" class="form-control" name="message" rows="5"
                        ...
                        <button type="submit" id="contact-button" class="btn btn-warning btn-submit contact__button">Send Message</button>
